...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/09/05 18:49:45 by aait-ham          #+#    #+#             */
/*   Updated: 2021/09/05 18:49:46 by aait-ham         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	init_mutexes(t_mutexes *mutexes, t_arguments args)
{
	...
	if (mutexes == NULL)
		return (0);
	mutexes->forks = (pthread_mutex_t **)malloc(
			(args.nof + 1) * sizeof(pthread_mutex_t *));
